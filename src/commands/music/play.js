...
const lista = require ('../commands/configuration/queue')
...
module.exports = class Command {
  constructor(client) {
    ...
    this.name = "play";
    this.category = "Music";
    this.description = "comando para tocar musica";
    this.usage = "em testes";
    this.aliases = ["tocar"];
...
if(serverQueue) {
    if(serverQueue.radio == true)  lista.queue.delete(message.guild.id);
        ...
        embed: {
            title: `<:cancel:835222602884710438> | ${message.author}, conecte-se ao canal de **voz** que eu estou conectado para **prosseguir**`,
            color: 0x36393e,
        }
    })
}
...
if(!args[0]) return message.channel.send({
    embed: {
        description: ` | ${message.author}, insira o **NOME** ou a **URL** da música desejada`,
        color: 0x36393e,
...
var url = args[0] ? args[0].replace(/<(.+)>/g, '$1') : '';
		...
		if(!voiceChannel) return message.channel.send({
            embed: {
                description: ` | ${message.author}, conecte-se a um canal de **voz**`,
                color: 0x36393e,
        ...
        if(url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
            ...
            var Ma = await message.channel.send({
                embed: {
                    description: `<a:loading:835220669188931664> | ${message.author}, estou conectando ao **__YouTube__**....`,
                    color: 0x36393e,
                    }
                })
                ...
                setTimeout(async () => {
                    ...
                    var Mb = await Ma.edit({
                             embed: {
                                description: `<a:loading:835220669188931664> | ${message.author}, pesquisando a **__PlayList__** desejada...`,
                                 color: 0x36393e,
                                 }
                             })
...
async function OKp(Mb) {
        ...
        setTimeout(() => {
            ...
            var embed = new Discord.MessageEmbed()
                    ...
                    .setTitle('<a:music:835223195429765150> **Playlist** Adicionada a Fila:')
                        .setThumbnail(tumb)
            ...
            Mb.edit({
                    embed: {
                        description: `<:cancel:835222602884710438> | ${message.author}, essa **Playlist** não **\`existe\`** ou é **\`privada\`**`,
                        color: 0x36393e,
                            }
                        })    
                    })
        ...
        try {
            ...
            message.channel.send({
                embed: {
                    description: `<:cancel:835222602884710438> | ${message.author},  esse link não **\`corresponde\`** há nenhum vídeo do **\`YouTube\`**`,
                    color: 0x36393e,
                    }
                })
            }
...
async function OK(Mb) {
                    ...
                    setTimeout(async () => { 
                            ...
                            Mb.edit({
                                embed: {
                                    description: `<:cancel:835222602884710438> | ${message.author}, não conseguir obter **resultados**`,
                                    color: 0x36393e,
                                }
                            })
                        }, 1200)
                    ...
                    .setTitle(`<:cancel:835222602884710438> Resultados da Pesquisa: **${razao}**`)
                        .setTimestamp()
                            .setColor('#36393e')
                    ...
                    if(coletado.first().content === 'cancelar') {
                        ...
                        message.channel.send({
                            embed: {
                                description: `<:cancel:835222602884710438> | ${message.author}, resposta **__inválida__**, tente **novamente**`,
                                color: 0x36393e,
                    ...
                    message.channel.send({
                        embed: {
                            description: `<:cancel:835222602884710438> | ${message.author}, tempo **__expirado__**, tente **novamente**`,
                            color: 0x36393e,
...
var a = await message.channel.send({
    embed: {
        description: `<a:loading:835220669188931664> | ${message.author}, cancelando a **__Pesquisa__**....`,
        color: 0x36393e,
...
var serverQueue = lista.queue.get(message.guild.id);
    ...
    try {
		...
		message.channel.send({
                embed: {
                    description: `<:cancel:835222602884710438> | ${message.author}, eu não pude entrar no canal de **voz**`,
                    color: 0x36393e,
            }
        })
        ...
        var embed = new Discord.MessageEmbed()
            ...
            .addField('<a:music:835223195429765150> Adicionada á Fila', `**${song.title}**`, false)
                .addField(`<a:uptime:835228059992588328:> Duração:`, `**\`[${song.duracao}]\`**`, true)
...
dispatcher.setVolumeLogarithmic(serverQueue.volume / 10);
    ...
    var embedH = new Discord.MessageEmbed()
        ...
        .addField('<:cancel:835222602884710438> Começando a Tocar', `**${s.title}**`, false)
            .addField('<a:uptime:835228059992588328:> Duração:', `**\`[${s.duracao}]\`**`, true)
